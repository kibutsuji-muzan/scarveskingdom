...
<head>
    ...
    <meta name="description" content="Ready Stock - Scarves Kingdom is a scarf manufacturing company owned by M.A. Business Enterprise Pvt. Ltd.">
    ...
    <link rel="canonical" href="https://www.scarveskingdom.com/ready-stock.html" />
                ...
                <div class="col-lg-8 col-md-8">
                    <nav class="header_menu mobile-menu">
                        <ul>
                            ...
                            <li class="active"><a href="<?php echo $base;?>ready-stock.html">Ready Stock</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                        <?php
                        $query = mysqli_query($con, "SELECT id, name, status FROM site_collections where cat='Ready Stock' AND status='1' order by id limit 40");
